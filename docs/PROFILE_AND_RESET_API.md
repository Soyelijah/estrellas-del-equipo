...
- `PUT /api/admin/users/:userId/avatar`: el administrador guarda o reemplaza la foto de perfil.
...
- `PUT /api/account/avatar` y `DELETE /api/account/avatar`: cada trabajador administra su foto.
